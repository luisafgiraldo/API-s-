...
Epoch_trains = ct.execute(v_commands_epoch_trains, url_base, api_key, df)

end_time = datetime.now()
execution_time = (end_time - start_time).total_seconds() / 3600
print(f"Execution time: {execution_time:.2f} hours")

result_vertical_reset = Epoch_trains

# Define the file path
file_path = os.path.join("Epoch_trains", "reports", "report.xlsx")
