...
const API_URL = {
  staging: 'https://api.va.staging.landing.ai/v1/tools/agentic-object-detection',
  production: 'https://api.va.landing.ai/v1/tools/agentic-object-detection',
  dev: 'https://api.va.dev.landing.ai/v1/tools/agentic-object-detection'
}[tier];
