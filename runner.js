...
try {
  const output1 = execSync('node ratelimit/ratelimit-testADE-Tier1.js --tier staging --rpm 25 --duration 3', { stdio: 'pipe', encoding: 'utf-8' });
  console.log(output1); // <-- Imprime todos los logs en consola
